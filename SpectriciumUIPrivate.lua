...
local exploit = " Evon"
local version = "1.7.5.06 ".. exploit.. " Api"..  " Edition Beta"
...
PlayerSection:NewButton("kill all", "Kill All The Players",function()
for _,v in pairs(game:GetService("Workspace").GetPlayers()) do
v:FindFirstChild("Humanoid").Health = 0
end
end)
UpdateNoteSection:NewLabel("Added Kill All")
